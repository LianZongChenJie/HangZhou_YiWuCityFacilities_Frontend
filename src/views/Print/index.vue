...
const row = computed(() => cases.getById(route.params.id))
function doPrint() {
  window.print()
}
function doClose() {
...
.sheet { max-width: 860px; margin: 0 auto; background: #fff; padding: 24px 32px 48px; min-height: 100%; }
h2, .sub { text-align: center; margin: 0; }
.sub { color: #666; margin-bottom: 20px; }
table { width: 100%; border-collapse: collapse; }
th, td { border: 1px solid #333; padding: 10px 12px; font-size: 14px; }
th { width: 180px; background: #f7f7f7; text-align: left; font-weight: 600; }
</style>
